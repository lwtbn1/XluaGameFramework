...
namespace XLua.CSObjectWrap
{
    ...
    public class FileToolsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(FileTools);
        ...
        {
            return LuaAPI.luaL_error(L, "FileTools does not have a constructor!");
        }
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_LoadLuaFileUTF8Bytes_xlua_st_(RealStatePtr L)
        {
		    try {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_Test1_xlua_st_(RealStatePtr L)
        {
		    try {
